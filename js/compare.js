    ...
    barChart = new Chart(barCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Seek Time',
                    backgroundColor: ["rgba(255, 102, 102, 0.4)", "rgba(55, 224, 94, 0.63)", "rgba(204, 102, 255, 0.4)", "rgba(255, 204, 153, 0.4)", "rgba(255, 255, 153, 0.4)", "rgba(153, 255, 153, 0.4)"],
                    borderColor: ['rgba(255, 102, 102, 1)', 'rgb(4, 130, 40)', 'rgba(204, 102, 255, 1)', 'rgba(255, 204, 153, 1)', 'rgba(255, 255, 153, 1)', 'rgba(153, 255, 153, 1)'],
                    borderWidth: 2,
                    data: []
                }
            ]
